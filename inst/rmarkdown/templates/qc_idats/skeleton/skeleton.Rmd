...
cell_comp <- switch(
  ...
  },
  {
    ...
    beta_matrix <- na.exclude(minfi::getBeta(data_mset))
...
ggplot2::ggplot(
  ...
  ggplot2::geom_polygon(
    mapping = aes(x = qc_xmedian, y = qc_ymedian, fill = factor(qc_predicted_gender)),
    alpha = 0.1,
    data = annot_gender,
    inherit.aes = FALSE
  ) +
  ...
  ggplot2::coord_cartesian(
    xlim = range(phenotypes[["qc_xmedian"]], na.rm = TRUE),
    ylim = range(phenotypes[["qc_ymedian"]], na.rm = TRUE)
  ) +
